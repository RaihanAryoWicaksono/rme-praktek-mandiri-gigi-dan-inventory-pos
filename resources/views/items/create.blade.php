<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Item / Bahan</h2>
    </x-slot>
    ...
    <div class="max-w-3xl space-y-5">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Tambah Item / Bahan</h1>
        </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="type" name="type" required
                                class="w-full px-3 py-2 text-sm border @error('type') border-red-400 @else border-gray-300 @enderror rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                            <option value="bahan" @selected(old('type') == 'bahan')>Bahan (Base Material)</option>
                            <option value="obat"  @selected(old('type') == 'obat')>Obat</option>
                            <option value="produk" @selected(old('type') == 'produk')>Produk / Retail</option>
                        </select>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="purchase_price" value="{{ old('purchase_price') }}" min="0" step="1"
                    ...
                    <div>
                        ...
                        <input type="number" name="selling_price" value="{{ old('selling_price') }}" min="0" step="1"
                               class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="min_stock_alert" value="{{ old('min_stock_alert', 10) }}" min="0" required
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="unit_use" value="{{ old('unit_use') }}" required placeholder="Contoh: ml, pcs"
                    ...
                    <div>
                        ...
                        <input type="text" name="unit_purchase" value="{{ old('unit_purchase') }}" placeholder="Contoh: Botol, Box"
                               class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="conversion_factor" value="{{ old('conversion_factor', 1) }}" min="1" required
                        ...
                        <p class="mt-1 text-xs text-teal-600">Contoh: 1 Botol = 100 ml → isi 100.</p>
