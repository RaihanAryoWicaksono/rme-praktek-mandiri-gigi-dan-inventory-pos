    ...
    <div class="space-y-5" x-data="{
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-center gap-1">
                                            ...
                                            <span class="text-gray-200">|</span>
                                            <button type="button"
                                                    @click="$dispatch('open-delete-modal', { url: '{{ route('kunjungan.destroy', $k) }}', name: '{{ addslashes($k->patient->display_name) }} — {{ $k->tanggal_kunjungan->format('d M Y') }}' })"
        ...
        <div x-show="showDeleteModal" x-cloak
            ...
            <div @click.away="showDeleteModal = false"
                ...
                <p class="text-sm text-gray-600 mb-1">Hapus kunjungan <span class="font-semibold text-red-600" x-text="itemName"></span>?</p>
                <p class="text-xs text-gray-400 mb-6">Rekam medis yang terkait dengan kunjungan ini juga akan terhapus.</p>
