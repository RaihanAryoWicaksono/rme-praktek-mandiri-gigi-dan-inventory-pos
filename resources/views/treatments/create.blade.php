<x-app-layout>
    ...
    <div class="max-w-2xl space-y-5">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Tambah Tindakan</h1>
        </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="category" value="{{ old('category') }}" placeholder="Contoh: Restorasi, Bedah Mulut"
                    ...
                    <div>
                        ...
                        <input type="number" name="base_price" value="{{ old('base_price', 0) }}" min="0" step="1000" required
